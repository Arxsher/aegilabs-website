...
const steps = [
  {
    ...
    description: "Map the repetitive steps, tools, messages, decisions, and approval points before building the agent.",
    code: `const supportAgent = new Agent({
  role: 'Customer Support',
  tools: ['inbox', 'crm', 'docs'],
  ...
  },
  {
    number: "02",
    title: "Deploy",
    subtitle: "the first agent",
    description: "Configure the agent, connect the tools, test outputs, and launch it on one focused workflow.",
    code: `await supportAgent.launch({
  workflow: 'reply-and-escalate',
  channel: 'inbox',
  output: 'resolved-or-handoff'
})`,
  },
  {
    number: "03",
    title: "Monitor",
    subtitle: "& improve",
    description: "Review performance, tune prompts and rules, then expand into more channels, teams, and workflows.",
    code: `aegilabs.monitor({
  agents: [supportAgent],
  metrics: ['resolution', 'handoffs', 'quality'],
  alerts: true
})
// review, tune, expand`,
  },

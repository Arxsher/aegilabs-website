      ...
      <nav 
        className={`mx-auto transition-all duration-500 ${
          isScrolled || isMobileMenuOpen
            ? "bg-white/[0.08] backdrop-blur-[28px] border border-white/15 rounded-2xl shadow-[0_18px_60px_rgba(255,255,255,0.08)] max-w-[1200px]"
      ...
      >
        ...
        >
          ...
          <a
            ...
            aria-label="AegiLabs home"
          >
            <img
              src="/aegilabs-logo-no-border.png"
              alt="AegiLabs"
              className={`w-auto object-contain transition-all duration-500 ${isScrolled ? "h-6 max-w-[120px]" : "h-7 max-w-[140px]"}`}
            />
          </a>
      ...
      >
        <div className="flex flex-col h-full px-8 pt-28 pb-8">
          ...
          >
            ...
            >
              <a href="/sign-up" onClick={() => setIsMobileMenuOpen(false)}>Deploy agent</a>
            </Button>
          </div>
        </div>
      </div>

...
const securityFeatures = [
  {
    ...
    description: "Sensitive actions can require review before execution.",
    image: "/images/isolated.jpg",
  },
  {
    icon: Lock,
    title: "Scoped permissions",
    description: "Agents only access the tools and data they need.",
    image: "/images/encrypted.jpg",
  },
  {
    icon: Eye,
    title: "Action logs",
    description: "Every message, update, and handoff can be inspected.",
    image: "/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "Clear boundaries",
    description: "Rules define what an agent can do and when to escalate.",
    image: "/images/permissions.jpg",
  },
];

const certifications = ["Human approval", "Audit logs", "Scoped access", "Data care"];
        ...
        <div className="mb-20">
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Agents can move fast without becoming uncontrolled. AegiLabs builds approval points, permissions, logs, and escalation rules into every workflow.
            </p>
          </div>
        </div>
          ...
          <div className={`lg:col-span-7 relative p-8 lg:p-12 border border-foreground/10 min-h-[400px] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              ...
              <div className="mt-8">
                ...
                <span className="block text-muted-foreground mt-2">Critical actions without review</span>
              </div>
            </div>
